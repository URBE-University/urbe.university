                ...
                <div class="w-full">
                    ...
                    <div class="mt-2">
                        <a href="<?php echo e(route('blog.post.show', ['slug' => $post->slug])); ?>">
                            <h2 class="font-bold text-xl underline"><?php echo e($post->title); ?></h2>
                        </a>
...
<?php echo $__env->make('layouts.website', ['settings' => $settings], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elvis/Projects/CUSTOMERS/URBE/urbe.university/resources/views/website/blog/index.blade.php ENDPATH**/ ?>