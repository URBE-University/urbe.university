...
} elseif ($_instance->childHasBeenRendered('6Y5jjiD')) {
    $componentId = $_instance->getRenderedChildComponentId('6Y5jjiD');
    $componentTag = $_instance->getRenderedChildComponentTagName('6Y5jjiD');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6Y5jjiD');
} else {
    $response = \Livewire\Livewire::mount('website.breadcrumbs');
    $html = $response->html();
    $_instance->logRenderedChild('6Y5jjiD', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
