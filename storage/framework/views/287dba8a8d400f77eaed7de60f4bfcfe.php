<?php $__env->startSection('content'); ?>
    ...
    <header class="relative flex items-center justify-center h-96 md:h-screen mb-12 overflow-hidden">
        ...
        <source src="<?php echo e(asset('videos/video.mp4')); ?>" type="video/mp4"/>Your browser does not support the video tag.</video>
    </header>
    ...
    <section class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-6 max-w-3xl mx-auto w-auto">
            <video class="rounded-lg" src="<?php echo e(asset('videos/video.mp4')); ?>" controls></video>
        </div>
    </section>
