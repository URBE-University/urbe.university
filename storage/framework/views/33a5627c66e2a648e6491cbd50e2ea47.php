            ...
            <div class="grid grid-cols-4 gap-8">
                <div class="col-span-4 sm:col-span-2 lg:col-span-1 rounded-md shadow bg-white text-center flex flex-col justify-between">
                    ...
                    <div class="px-6 py-2 w-full bg-slate-100 rounded-b-lg">
                        <a href="<?php echo e(route('admin.school.catalog')); ?>" class="secondary-btn">Manage</a>
                    </div>
                </div>
...
<?php /**PATH /home/elvis/Projects/CUSTOMERS/URBE/urbe.university/resources/views/livewire/admin/school/index.blade.php ENDPATH**/ ?>