<div>
    ...
    <input type="text" id="content" wire:model="code" class="hidden">

    <div x-data="{
            content: '<?php echo e($code); ?>',
            init() {
...
<?php /**PATH /home/elvis/Projects/CUSTOMERS/URBE/urbe.university/resources/views/livewire/code-editor.blade.php ENDPATH**/ ?>