...
<div class="w-full h-56" style="background-image: url(<?php echo e(asset('static_assets/page-header-bg.webp')); ?>)">
    <div class="h-full flex items-center justify-center">
        <h1 class="text-5xl font-extrabold text-white"><?php echo e($category->name); ?></h1>
    </div>
...
} elseif ($_instance->childHasBeenRendered('ilR1CPi')) {
    $componentId = $_instance->getRenderedChildComponentId('ilR1CPi');
    $componentTag = $_instance->getRenderedChildComponentTagName('ilR1CPi');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ilR1CPi');
} else {
    $response = \Livewire\Livewire::mount('website.breadcrumbs');
    $html = $response->html();
    $_instance->logRenderedChild('ilR1CPi', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php echo $__env->make('layouts.website', ['settings' => $settings, 'title' => 'Articles under ' . $category->name], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elvis/Projects/CUSTOMERS/URBE/urbe.university/resources/views/website/blog/category.blade.php ENDPATH**/ ?>