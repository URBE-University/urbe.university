                        ...
                        <div class="flex items-center justify-end space-x-3">
                            <?php if($page->deleted_at): ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('page:delete')): ?>
                                    <button wire:click="restore(<?php echo e($page->id); ?>)" class="text-sm">Restore</button>
                                    <button wire:click="delete(<?php echo e($page->id); ?>)" class="text-sm text-red-600">Permanently delete</button>
                                <?php endif; ?>
                            <?php else: ?>
