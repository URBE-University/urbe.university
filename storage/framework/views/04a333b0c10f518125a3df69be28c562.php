...
<div class="w-full h-56" style="background-image: url(<?php echo e(asset('static_assets/page-header-bg.webp')); ?>)">
    <div class="h-full flex items-center justify-center">
        <h1 class="text-5xl font-extrabold text-white"><?php echo e(__("Articles by ") . $author->name); ?></h1>
    </div>
...
} elseif ($_instance->childHasBeenRendered('vgJThEz')) {
    $componentId = $_instance->getRenderedChildComponentId('vgJThEz');
    $componentTag = $_instance->getRenderedChildComponentTagName('vgJThEz');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('vgJThEz');
} else {
    $response = \Livewire\Livewire::mount('website.breadcrumbs');
    $html = $response->html();
    $_instance->logRenderedChild('vgJThEz', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-3 gap-8">
        <?php $__empty_1 = true; $__currentLoopData = $author->posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php echo $__env->make('layouts.website', ['settings' => $settings, 'title' => 'Articles by ' . $author->name], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elvis/Projects/CUSTOMERS/URBE/urbe.university/resources/views/website/blog/author.blade.php ENDPATH**/ ?>