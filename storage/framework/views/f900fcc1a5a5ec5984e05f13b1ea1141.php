<div class="py-12 max-w-full prose">
    <h3><?php echo e(__("Shortcodes Cheat Sheet")); ?></h3>
    ...
    <div class="mt-6">
        <table class="table-fixed">
            <thead>
              ...
              <tbody>
                <tr>
                    <td role="row" class="font-semibold">[cta]</td>
                    <td>Inserts call to action banner.</td>
                </tr>
                <tr>
                    <td role="row" class="font-semibold">[posts_teaser]</td>
                    <td>Inserts the posts teaser section. It contains the latest 3 blog posts.</td>
                </tr>
                <tr>
...
<?php /**PATH /home/elvis/Projects/CUSTOMERS/URBE/urbe.university/resources/views/layouts/partials/shortcodes.blade.php ENDPATH**/ ?>