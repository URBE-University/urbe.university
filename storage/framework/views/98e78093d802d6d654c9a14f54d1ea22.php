                    ...
                    <div class="col-span-3 md:col-span-1">
                        <div class="w-full">
                            <a href="<?php echo e(route('blog.post.show', ['slug' => $related->slug])); ?>" aria-label="Link to post">
                                <img src="<?php echo e(asset($related->featured_image)); ?>" alt="<?php echo e($related->featured_image_alt_text); ?>" class="w-full aspect-auto rounded-md shadow">
                            </a>
                            <div class="mt-2">
...
<?php echo $__env->make('layouts.website', ['settings' => $settings, 'page' => $post], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elvis/Projects/CUSTOMERS/URBE/urbe.university/resources/views/website/blog/show.blade.php ENDPATH**/ ?>
