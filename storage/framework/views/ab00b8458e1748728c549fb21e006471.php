    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-4 gap-8">
                ...
                <div class="col-span-4 sm:col-span-2 lg:col-span-1 rounded-lg shadow bg-white text-center flex flex-col justify-between">
                    <div class="p-6">
                        <div class="text-blue-600 p-3 bg-blue-100 inline-flex rounded-lg">
                    ...
                    <div class="px-6 py-2 w-full bg-slate-100 rounded-b-lg">
                        <a href="<?php echo e(route('admin.seo.site.settings')); ?>" class="secondary-btn">Manage</a>
                    </div>
                </div>

                <div class="col-span-4 sm:col-span-2 lg:col-span-1 rounded-lg shadow bg-white text-center flex flex-col justify-between">
                    <div class="p-6">
                        <div class="text-green-600 p-3 bg-green-100 inline-flex rounded-lg">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    ...
                    <div class="px-6 py-2 bg-slate-100 rounded-b-lg">
                        <a href="<?php echo e(route('admin.seo.socialmedia')); ?>" class="secondary-btn">Manage</a>
                    </div>
                </div>
                ...
                <div class="col-span-4 sm:col-span-2 lg:col-span-1 rounded-lg shadow bg-white text-center flex flex-col justify-between">
                    <div class="p-6">
                        <div class="text-indigo-600 p-3 bg-indigo-100 inline-flex rounded-lg">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    ...
                    <div class="px-6 py-2 bg-slate-100 rounded-b-lg">
                        <a href="<?php echo e(route('admin.seo.webmaster.tools')); ?>" class="secondary-btn">Manage</a>
                    </div>
                </div>

                <div class="col-span-4 sm:col-span-2 lg:col-span-1 rounded-lg shadow bg-white text-center flex flex-col justify-between">
                    <div class="p-6">
                        <div class="text-yellow-600 p-3 bg-yellow-100 inline-flex rounded-lg">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    ...
                    <div class="px-6 py-2 bg-slate-100 rounded-b-lg">
                        <a href="<?php echo e(route('admin.seo.instant.index')); ?>" class="secondary-btn">Manage</a>
                    </div>
                </div>

                <div class="col-span-4 sm:col-span-2 lg:col-span-1 rounded-lg shadow bg-white text-center flex flex-col justify-between">
                    <div class="p-6">
                        <div class="text-purple-600 p-3 bg-purple-100 inline-flex rounded-lg">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    ...
                    <div class="px-6 py-2 bg-slate-100 rounded-b-lg">
                        <a href="<?php echo e(route('admin.seo.redirects')); ?>" class="secondary-btn">Manage</a>
                    </div>
                </div>

                <div class="col-span-4 sm:col-span-2 lg:col-span-1 rounded-lg shadow bg-white text-center flex flex-col justify-between">
                    <div class="p-6">
                        <div class="text-cyan-600 p-3 bg-cyan-100 inline-flex rounded-lg">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
