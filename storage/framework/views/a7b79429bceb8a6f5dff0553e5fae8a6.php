    ...
    <div class="mt-2 block">
        ...
        <?php elseif(!$image && $post->featured_image): ?>
            <div class="relative">
                ...
                <img src="<?php echo e(asset($post->featured_image)); ?>" alt="" class="block w-full aspect-video rounded-md object-cover object-center">
            </div>
        <?php endif; ?>
        ...
        <?php if($image): ?>
            <button type="button" wire:click="setFeaturedImage" class="mt-4 w-full text-center p-2 rounded-md bg-black text-white"><?php echo e(__("Upload Now")); ?></button>
        <?php endif; ?>
