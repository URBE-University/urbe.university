<div>
    ...
    <div class="mt-2 block">
        ...
        <?php elseif(!$image && $post->featured_image): ?>
            <div class="relative">
                ...
                <img src="<?php echo e(asset($post->featured_image)); ?>" alt="" class="block w-full aspect-video rounded-lg object-cover object-center">
            </div>
        <?php endif; ?>
...
<?php endif; ?>
        ...
        <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'jetstream::components.input','data' => ['type' => 'text','id' => 'image_alt','wire:model' => 'image_alt','placeholder' => 'featured image alt text','class' => 'mt-1 w-full']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
        <div class="mt-2 flex justify-end">
            <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'jetstream::components.button','data' => ['wire:click' => 'saveAltText']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH /home/elvis/Projects/CUSTOMERS/URBE/urbe.university/resources/views/livewire/admin/post/upload-featured-image.blade.php ENDPATH**/ ?>