...
?>
                    <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                        ...
                        ]); ?>"><?php echo e(!is_null($post->published_at) ? 'Published' : 'Draft'); ?></div>

                    <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => 'publish']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'publish']); ?><?php echo e(!is_null($post->published_at) ? 'Unpublish' : 'Publish'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
