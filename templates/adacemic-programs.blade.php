<div class="w-full" style="background-image: url(https://dev.urbe.university/static_assets/page-header-bg.webp)">
    <div class="mx-auto h-full max-w-5xl px-4 sm:px-6 lg:px-8">
        <div class="text-white py-12 sm:py-24">
          <h1 class="border-l-8 border-l-white pl-4 text-5xl font-extrabold">Academic Programs</h1>
          <p class="text-lgmt-6 mt-6 text-lg md:text-xl">Whatever your passion, we’ve got the program to get you going in the right direction.</p>
        </div>
    </div>
  </div>
  ...
  <div class="py">[owner_banner]</div>

  <div class="mx-auto max-w-5xl px-4 text-base sm:px-6 lg:px-8">
    <div class="py-12">[cta]</div>
  </div>
