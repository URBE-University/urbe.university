<section class="py-12 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    ...
    <div class="mt-12">
        <a href="{{ route('blog.post.index') }}" class="px-5 py-2.5 border rounded-lg text-base text-slate-600 hover:bg-sky-500 hover:text-white hover:border-sky-500 transition-all">Read more articles</a>
    </div>
</section>
