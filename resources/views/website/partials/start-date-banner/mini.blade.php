@if (\App\Models\StartDate::where('start_date', '>', today())->count() > 0)
    <a href="https://admissions.urbe.university?utm_campaign='website_traffic'&utm_source='{{url()->current()}}'&utm_medium='start_date_banner'" target="_blank" class="bg-white/20 px-3 py-1 rounded-full flex items-center">
