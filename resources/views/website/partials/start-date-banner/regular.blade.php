        ...
        <div class="grid grid-cols-12 gap-4 items-center">
            <div class="col-span-4 flex items-center gap-2">
                ...
                <div class="">
                    ...
                    <h2 class="text-2xl font-bold">{{ Carbon\Carbon::parse(\App\Models\StartDate::where('start_date', '>', today())->orderBy('start_date', 'ASC')->first()->apply_by_date)->format('F jS') }}</h2>
                </div>
            </div>
            ...
            <div class="col-span-3 flex items-center gap-2">
                ...
                <div class="">
                    ...
                    <h2 class="text-2xl font-bold">{{ Carbon\Carbon::parse(\App\Models\StartDate::where('start_date', '>', today())->orderBy('start_date', 'ASC')->first()->start_date)->format('F jS') }}</h2>
                </div>
            </div>
