        ...
        <div class="h-full sm:flex items-center space-y-4 sm:space-y-0 sm:space-x-6 lg:space-x-12">
            <div class="h-full flex items-center gap-2">
                ...
                <div>
                    ...
                    <div class="text-xl font-bold">{{ Carbon\Carbon::parse(\App\Models\StartDate::where('start_date', '>', today())->orderBy('start_date', 'ASC')->first()->apply_by_date)->format('F jS') }}</div>
                </div>
            </div>
            ...
            <div class="h-full flex items-center gap-2">
                ...
                <div class="">
                    ...
                    <div class="text-xl font-bold">{{ Carbon\Carbon::parse(\App\Models\StartDate::where('start_date', '>', today())->orderBy('start_date', 'ASC')->first()->start_date)->format('F jS') }}</div>
                </div>
            </div>
        </div>

        <div class="h-full sm:flex items-center">
            <a href="https://admissions.urbe.university?utm_campaign='website_traffic'&utm_source='{{url()->current()}}'&utm_medium='start_date_banner'"
                target="_blank"
        ...
        <div class="grid grid-cols-12 gap-4 items-center">
            <div class="col-span-4 flex items-center gap-2">
                ...
                <div class="">
                    ...
                    <h2 class="text-xl font-bold">{{ Carbon\Carbon::parse(\App\Models\StartDate::where('start_date', '>', today())->orderBy('start_date', 'ASC')->first()->apply_by_date)->format('F jS') }}</h2>
                </div>
            </div>
            ...
            <div class="col-span-3 flex items-center gap-2">
                ...
                <div class="">
                    ...
                    <h2 class="text-xl font-bold">{{ Carbon\Carbon::parse(\App\Models\StartDate::where('start_date', '>', today())->orderBy('start_date', 'ASC')->first()->start_date)->format('F jS') }}</h2>
                </div>
            </div>
            <div class="col-span-3 col-start-10">
                <a href="https://admissions.urbe.university?utm_campaign='website_traffic'&utm_source='{{url()->current()}}'&utm_medium='start_date_banner'" target="_blank" class="block w-full py-4 bg-sky-500 rounded-full text-white text-center">Apply Now</a>
            </div>
        </div>
    </div> --}}
@endif
