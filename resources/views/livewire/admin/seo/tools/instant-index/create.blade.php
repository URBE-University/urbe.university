<div>
    <x-jet-button wire:click="$toggle('modal')">Submit URLs</x-jet-button>

    <x-jet-dialog-modal wire:model="modal">
        <x-slot name="title">Instant Indexing Options</x-slot>
        <x-slot name="content">
            <div class="">
                <x-jet-label for="urls" value="Insert URLs to send to the IndexNow API (one per line, up to 1000):" />
        ...
        <x-slot name="footer">
            ...
            <x-jet-button wire:click="save" class="ml-4">Submit URLs</x-jet-button>
        </x-slot>
    </x-jet-dialog-modal>
</div>
