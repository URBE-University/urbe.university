        ...
        @forelse ($items as $item)
            ...
            >
                ...
                <div class="flex items-center">
                    @livewire('admin.menu.edit', ['selector' => $item->location, 'menu' => $item], key('edit-{{$item->id}}'))
