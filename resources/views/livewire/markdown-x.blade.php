<div class="relative">
    <div x-data="markdown()" x-ref="markdownX" data-key="{{ $key }}" id="markdown-{{ $key }}" class="relative w-full" x-init="init()">
        ...
        <div x-show="section == 'help'" class="@if(isset($style['help'])){{ $style['help'] }}@else{{ 'bg-white min-h-96 px-5 pt-10 relative z-30 prose dark:bg-dark-900 max-w-none' }}@endif" x-cloak>
